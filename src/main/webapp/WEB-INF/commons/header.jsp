...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jieyou.com/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="../images/taotao-logo.gif" width="100" height="60" alt="解忧"></a></div>
		<!--logo end-->
		<div id="search-2013">
	...
	<div class="w">
		<div id="nav-2013">
			<div id="categorys-2013" class="categorys-2014">
				<div class="mt ld">
					<h2><a href="http://www.jieyou.com/products/allitem.html" clstag="homepage|keycount|home2013|06a">全部商品分类<b></b></a></h2>
				</div>
				<div id="_JD_ALLSORT" class="mc">
					...
					<div class="extra" >
						<a {if="" pageconfig.ishome}clstag="homepage|keycount|home2013|0614a"
							{="" if}="" href="http://www.jieyou.com/products/allitem.html">全部商品分类</a>
					</div>
				</div>
			</div>
