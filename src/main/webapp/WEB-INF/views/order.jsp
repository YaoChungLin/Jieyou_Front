...
<!--shortcut end-->
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="林耀宗"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="13000000000"/>
		<input type="hidden" name="orderShipping.receiverState" value="广东省"/>
		<input type="hidden" name="orderShipping.receiverCity" value="江门市"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="蓬江区"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="五邑大学玫瑰园48-404 "/>
	</form>
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://www.jieyou.com/"><img src="/images/taotao-logo.gif"  alt="解忧杂货店" width="100" height="60"/></a></div>
						...
						<div id="checkout-floatbar" class="checkout-buttons group">
							<div class="inner">
								...
								<div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
									部分商品货到付款方式：先由解忧快递配送“提货单”并收款，然后厂商发货。
								</div>
							</div>
